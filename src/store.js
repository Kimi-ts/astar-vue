...
export default new Vuex.Store({
  ...
  mutations: {
    initGrid() {
      this.state.grid["1"] = {value: "1", neibs: ["2", "5"], weight: 0};
      this.state.grid["2"] = { value: "2", neibs: ["1", "3", "6"], weight: 0 };
      this.state.grid["3"] = { value: "3", neibs: ["2", "7", "4"], weight: 0 };
      this.state.grid["4"] = { value: "4", neibs: ["3", "8"], weight: 0 };
      this.state.grid["5"] = { value: "5", neibs: ["1", "6"], weight: 0 };
      this.state.grid["6"] = { value: "6", neibs: ["5", "2", "7"], weight: 0 };
      this.state.grid["7"] = { value: "7", neibs: ["6", "3", "8"], weight: 0 };
      this.state.grid["8"] =  { value: "8", neibs: ["4", "7"], weight: 0 };
